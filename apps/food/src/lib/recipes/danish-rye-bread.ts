...
export const danishRyeBread: Recipe = {
  ...
  ingredients: [
    { amount: 200, note: "g", item: "Sourdough starter" },
    { amount: 200, note: "g", item: "Finely milled rye flour" },
    { amount: 300, note: "g", item: "Wheat flour" },
    { amount: 500, note: "g", item: "Coarsely milled rye flour" },
    { amount: 1000, note: "g", item: "Water (500g pre-dough + 500g seed mix)" },
    { amount: 100, note: "g", item: "Dark syrup" },
    { amount: 200, note: "g", item: "Cracked rye" },
    { amount: 50, note: "g", item: "Flaxseeds" },
    { amount: 200, note: "g", item: "Sunflower seeds" },
    { amount: 25, note: "g", item: "Flake salt" },
    { amount: 1, note: "tsp", item: "Fennel seeds" },
    { amount: 2, note: "tsp", item: "Caraway (optional — good if you want it extra spiced)" },
    { amount: 1, note: "tsp", item: "Oregano (optional — good if you want it extra spiced)" },
    { item: "Ground clove (1 pinch)" },
  ],
  steps: [
